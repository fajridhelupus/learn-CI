...
<html>
    ...
    <title>Ajax Crud Upload Gambar</title>
...
<body>
    <div class="container">
        <h1 style="font-size:20pt">Ajax Crud Upload Gambar</h1>

        <h3>Data Pengguna</h3>
        <br />
        <button class="btn btn-success" onclick="add_crud()"><i class="glyphicon glyphicon-plus"></i> Tambah Pengguna</button>
...
function add_crud()
{
    ...
    $('.modal-title').text('Add crud'); // Set Title to Bootstrap modal title
...
function edit_crud(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="jkel"]').val(data.jenis_kelamin);
            $('[name="alamat"]').val(data.alamat);
            $('[name="username"]').val(data.username);
            $('[name="pass"]').hide();
            $('[name="email"]').val(data.email);
            $('[name="tgl_lahir"]').datepicker('update',data.tanggal_lahir);
            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Edit crud'); // Set title to Bootstrap modal title
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">crud Form</h3>
            </div>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="email" placeholder="Name" class="form-control" type="email">
                                <span class="help-block"></span>
                            </div>
                        </div>
						<div class="form-group">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="pass" placeholder="Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
